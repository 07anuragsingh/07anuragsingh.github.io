    ...
    <div className="fixed inset-0 z-50 pointer-events-none overflow-hidden">
      {Array.from({ length: 20 }).map((_, i) => (
        <motion.span
          ...
          className="absolute bottom-6 left-1/2 text-pink-500 text-2xl"
        >
          ❤️
        </motion.span>
      ))}
              ...
              {status === 'success' && (
                <div className="relative">
                  ...
                  <motion.div
                    ...
                    className="relative z-10 p-4 bg-green-100 dark:bg-green-900/30 
                 text-green-700 dark:text-green-300 rounded-lg text-sm"
                  >
                    <p className="font-bold">Message sent successfully!</p>
                    <p className="mt-1">
                      Important: If this is your first time, please check your{" "}
                      <span className="underline">email and spam folder</span> to activate the form.
                    </p>
                  </motion.div>
                </div>
              )}
